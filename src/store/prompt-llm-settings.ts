...
export const promptLlmSettingsSchema = z.object({
  ...
  characterPromptJsonField: z.string(),
  characterUcJsonField: z.string(),
  characterPositionJsonField: z.string(),
  positivePromptExtractPattern: z.string(),
  negativePromptExtractPattern: z.string(),
  characterPromptExtractPattern: z.string(),
  characterUcExtractPattern: z.string(),
...
export function recoverPromptLlmSettings(value: unknown): PromptLlmSettings {
  ...
  return {
    ...
    characterPromptJsonField: read('characterPromptJsonField', z.string()),
    characterUcJsonField: read('characterUcJsonField', z.string()),
    ...
    characterPromptExtractPattern: read('characterPromptExtractPattern', z.string()),
    characterUcExtractPattern: read('characterUcExtractPattern', z.string()),
