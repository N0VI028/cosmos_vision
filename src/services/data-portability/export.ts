...
function createSectionBuilders(
  ...
  return {
    ...
    comfyUIBasicSettings: () => ({
      ...
      positivePromptPresetId: settings.comfyui.positivePromptPresetId,
      negativePromptPresetId: settings.comfyui.negativePromptPresetId,
    }),
    comfyUIWorkflowPresets: () => _.cloneDeep(settings.comfyui.workflowPresets),
    comfyUILoraPresets: () => _.cloneDeep(settings.comfyui.loraPresets),
